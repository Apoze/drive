...
import FavoritesPage from "@/pages/explorer/items/favorites";
...
describe("FavoritesPage", () => {
  ...
  it("keeps the favorites route shell on the favorite filter and default route", () => {
  ...
  it("keeps the global explorer layout host wired as the page getLayout", () => {
    ...
    expect(FavoritesPage.getLayout?.(page)).toBe(page);
