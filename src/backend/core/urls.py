...
urlpatterns = [
    path(
        f"api/{settings.API_VERSION}/internal/transfers/files/",
        SuiteFileView.as_view(consumer="TRANSFERS"),
    ),
    path(f"api/{settings.API_VERSION}/internal/transfers/chunks/", SuiteFileChunksView.as_view()),
    path(
