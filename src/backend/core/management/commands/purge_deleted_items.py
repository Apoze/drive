"""Purge deleted items from database and storage."""
...
class Command(BaseCommand):
    """Queue purges for hard-deleted and expired soft-deleted items."""

    help = "Purge deleted items"

    def handle(self, *args, **options):
        """Browse purgeable items and queue them for item purge processing."""
