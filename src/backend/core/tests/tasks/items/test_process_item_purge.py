...
def test_process_item_purge_neither_soft_nor_hard_deleted(
    caplog,
...
def test_process_item_purge_soft_deleted_not_purgeable(
    caplog,
    django_assert_num_queries,
    settings,
):
...
def test_process_item_purge_item_file_is_ready(caplog):
